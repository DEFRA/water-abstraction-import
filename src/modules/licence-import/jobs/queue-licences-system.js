...
const ImportLicenceSystemJob = require('./import-licence-system.js')

const JOB_NAME = 'licence-import.queue-licences-system'

function createMessage () {
  return {
    name: JOB_NAME,
    options: {
      singletonKey: JOB_NAME, expireIn: '1 hours'
    }
  }
}
...
module.exports = {
  createMessage, handler, onComplete, name: JOB_NAME
}
