...
const SyncEndOfLicenceProcess = require('../../sync-end-of-licence/process.js')

const STEP_NAME = 'sync-end-of-licence'
...
async function go () {
  ...
  step.messages = await SyncEndOfLicenceProcess.go(false)
