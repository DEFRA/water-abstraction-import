...
async function go (log = false) {
  try {
    ...
    await _cleanUpChargeElements()
    await _cleanUpChargeVersions()
...
async function _chargeVersions () {
  ...
  // scheme.
  await db.query(`
    INSERT INTO water.charge_versions (licence_ref, scheme, external_id, version_number, start_date, status, apportionment,
...
async function _cleanUpChargeElements () {
...
async function _cleanUpChargeVersions () {
