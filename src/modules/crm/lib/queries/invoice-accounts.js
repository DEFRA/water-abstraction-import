...
INSERT INTO crm_v2.invoice_accounts (company_id, invoice_account_number, start_date, date_created, date_updated)
...
ON CONFLICT (invoice_account_number) DO UPDATE SET start_date=EXCLUDED.start_date, date_updated=EXCLUDED.date_updated`;
...
FROM import."NALD_IAS_INVOICE_ACCS" i
LEFT JOIN crm_v2.invoice_accounts ia ON i."IAS_CUST_REF"=ia.invoice_account_number
