...
experiment('modules/licence-crm-v2-import/lib/transformer.js', () => {
  ...
  beforeEach(() => {
    const licence = CrmV2ImportFixture.createLicence()
    const roleDetail = CrmV2ImportFixture.createRole(licence)
    const roleParty = CrmV2ImportFixture.createParty()
    const roleAddress = CrmV2ImportFixture.createAddress()
    ...
    versions.forEach((version) => {
      version.parties = [ CrmV2ImportFixture.createParty() ]
    })
